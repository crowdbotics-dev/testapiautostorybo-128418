...
## Project Structure
    ...
    ├── testapiautostorybo_128418  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_128418`
...
2. Clone this repo and `cd testapiautostorybo_128418`
